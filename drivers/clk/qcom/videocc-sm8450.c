...
static const struct alpha_pll_config video_cc_pll0_sm8475_config = {
	/* .l includes CAL_L_VAL, L_VAL fields */
	.l = 0x1e,
	.alpha = 0x0,
	.config_ctl_val = 0x20485699,
...
static const struct alpha_pll_config video_cc_pll1_sm8475_config = {
	/* .l includes CAL_L_VAL, L_VAL fields */
	.l = 0x2b,
	.alpha = 0xc000,
	.config_ctl_val = 0x20485699,
...
static int video_cc_sm8450_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(pdev->dev.of_node, "qcom,sm8475-videocc")) {
		...
		clk_lucid_ole_pll_configure(&video_cc_pll0, regmap, &video_cc_pll0_sm8475_config);
		clk_lucid_ole_pll_configure(&video_cc_pll1, regmap, &video_cc_pll1_sm8475_config);
	} else {
