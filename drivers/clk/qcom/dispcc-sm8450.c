...
static const struct alpha_pll_config disp_cc_pll0_sm8475_config = {
	.l = 0xd,
	.alpha = 0x6492,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00182261,
...
static const struct alpha_pll_config disp_cc_pll1_sm8475_config = {
	.l = 0x1f,
	.alpha = 0x4000,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00182261,
...
static int disp_cc_sm8450_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(pdev->dev.of_node, "qcom,sm8475-dispcc")) {
		...
		clk_lucid_ole_pll_configure(&disp_cc_pll0, regmap, &disp_cc_pll0_sm8475_config);
		clk_lucid_ole_pll_configure(&disp_cc_pll1, regmap, &disp_cc_pll1_sm8475_config);
	} else {
