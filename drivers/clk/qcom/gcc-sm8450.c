...
static struct clk_regmap *gcc_sm8450_clocks[] = {
	...
	[GCC_GPLL2] = NULL, /* Not NULL for SM8475 */
	[GCC_GPLL3] = NULL, /* Not NULL for SM8475 */
};
...
static int gcc_sm8450_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(pdev->dev.of_node, "qcom,sm8475-gcc")) {
		...
		gcc_sm8450_desc.clks[GCC_GPLL2] = &gcc_gpll2.clkr;
		gcc_sm8450_desc.clks[GCC_GPLL3] = &gcc_gpll3.clkr;
	}
