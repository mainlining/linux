...
static const struct alpha_pll_config gpu_cc_pll0_sm8475_config = {
	.l = 0x1d,
	.alpha = 0xb000,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00182261,
...
static const struct alpha_pll_config gpu_cc_pll1_sm8475_config = {
	.l = 0x34,
	.alpha = 0x1555,
	.config_ctl_val = 0x20485699,
	.config_ctl_hi_val = 0x00182261,
...
static int gpu_cc_sm8450_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(pdev->dev.of_node, "qcom,sm8475-gpucc")) {
		...
		clk_lucid_ole_pll_configure(&gpu_cc_pll0, regmap, &gpu_cc_pll0_sm8475_config);
		clk_lucid_ole_pll_configure(&gpu_cc_pll1, regmap, &gpu_cc_pll1_sm8475_config);
	} else {
